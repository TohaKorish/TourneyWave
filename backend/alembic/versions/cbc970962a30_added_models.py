...
Revision ID: cbc970962a30
Revises: 9ddb72de2d6a
Create Date: 2024-10-21 22:12:50.644901
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('CREATED', 'ACTIVATED', 'OPEN', 'COMPLETED', name='tournamentstatusenum'), nullable=False),
